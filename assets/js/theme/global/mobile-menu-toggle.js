...
export class MobileMenuToggle {
    ...
    bindEvents() {
        ...
        // Close-only buttons inside the menu (e.g. mobileMenu-toggle-inner)
        // Bound directly (not delegated) because menu.js calls stopPropagation on #menu clicks
        this.onInnerCloseClick = (event) => {
            event.preventDefault();
            this.hide();
        };
        $('.mobileMenu-toggle-inner').on('click', this.onInnerCloseClick);
    ...
    unbindEvents() {
        ...
        $('.mobileMenu-toggle-inner').off('click', this.onInnerCloseClick);
